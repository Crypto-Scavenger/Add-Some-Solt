			...
			<form method="post" class="ass-settings-form">
				...
				<table class="form-table">
					<tr>
						...
						<td>
							<label>
								<input type="checkbox" name="schedule_enabled" value="1" <?php checked( $settings['schedule_enabled'], '1' ); ?>>
					...
					<tr>
						...
						<td>
							<select name="schedule_frequency" id="schedule_frequency">
								<option value="daily" <?php selected( $settings['schedule_frequency'], 'daily' ); ?>><?php esc_html_e( 'Daily', 'add-some-solt' ); ?></option>
								<option value="weekly" <?php selected( $settings['schedule_frequency'], 'weekly' ); ?>><?php esc_html_e( 'Weekly', 'add-some-solt' ); ?></option>
								<option value="monthly" <?php selected( $settings['schedule_frequency'], 'monthly' ); ?>><?php esc_html_e( 'Monthly', 'add-some-solt' ); ?></option>
								<option value="quarterly" <?php selected( $settings['schedule_frequency'], 'quarterly' ); ?>><?php esc_html_e( 'Quarterly', 'add-some-solt' ); ?></option>
								<option value="biannually" <?php selected( $settings['schedule_frequency'], 'biannually' ); ?>><?php esc_html_e( 'Biannually', 'add-some-solt' ); ?></option>
							</select>
						</td>
					</tr>
					...
					<tr id="schedule_day_row">
						...
						<td>
							<select name="schedule_day" id="schedule_day">
								<?php for ( $i = 1; $i <= 31; $i++ ) : ?>
									<option value="<?php echo esc_attr( $i ); ?>" <?php selected( $settings['schedule_day'], $i ); ?>>
										<?php echo esc_html( $i ); ?>
									</option>
								<?php endfor; ?>
							</select>
					...
					<tr>
						...
						<td>
							<input type="time" name="schedule_time" id="schedule_time" value="<?php echo esc_attr( $settings['schedule_time'] ); ?>">
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<label>
								<input type="checkbox" name="reminder_enabled" value="1" <?php checked( $settings['reminder_enabled'], '1' ); ?>>
					...
					<tr>
						...
						<td>
							<input type="number" name="reminder_days" id="reminder_days" value="<?php echo esc_attr( $settings['reminder_days'] ); ?>" min="1" max="30" class="small-text">
